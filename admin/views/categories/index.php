  ...
  <div class="modal fade" id="editForm">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="code.php" id="addF" method="post" >
          <div class="modal-body">
            <input type="hidden" class="form-control" id="catId" value="" name="categoryid">
            <div class="form-group">
                <label> Category Name </label>
                <input type="text" class="form-control" id="catName" placeholder="Enter Category Name" name="editCategoryName" >
            </div>
            <div class="form-group">
              <label for="exampleInputFile">Status</label>
                <div class="form-group clearfix">
            ...
            <div class="card">
              <form action="">
                <div class="card-header">
                  <h2 class="card-title">Categories Records</h2>
                ...
                <div class="card-body">
                  ...
                  <?php
                    $docRef = $db->collection('categories');
...
<script>
    //Pass Id from table to modal (confirmation dialog)
    $(function () {
