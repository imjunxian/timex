  ...
  <div class="modal fade" id="editForm">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="code.php" id="addF" method="post" >
          <div class="modal-body">
            <input type="hidden" class="form-control" id="brandId" value="" name="brandid">
            <div class="form-group">
                <label> Brand Name </label>
                <input type="text" class="form-control" id="brandName" placeholder="Enter Brand Name" name="editBrandName" >
            </div>
            <div class="form-group">
              <label for="exampleInputFile">Status</label>
                <div class="form-group clearfix">
                          ...
                          $n++;
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  $result = 0;
                                  $numRow = [];
                                  $docValueRef = $db->collection('products');
                                  $countDoc = $docValueRef->where('brand', '==', $row->id())->documents();
