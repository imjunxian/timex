             ...
             <form action="code.php" method="post" id="loginForm">
                ...
                <div class="row">
                  ...
                  <div class="col-12 mt-2">
                    <button type="submit" name="sendBtn" class="btn btn-dark btn-block" id="sendBtn" disabled>Send</button>
                  </div>
                  <!-- /.col -->
                  </div>
                <br>
                <p class="login-card-footer-text "><a href="../auth/"><i class="fa fa-lock"></i> Remember Password?</a></p>
                </form>
            </div>
          </div>
        </div>
